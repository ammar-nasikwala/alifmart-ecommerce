...
tinymce.init({
    ...
    toolbar: "forecolor backcolor | bold italic underline | alignleft aligncenter alignright alignjustify |	formatselect fontsizeselect | bullist numlist | link | fullscreen",
	menu: {
