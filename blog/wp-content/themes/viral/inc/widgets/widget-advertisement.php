...
class Viral_advertisement extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                ...
                'description' => __('A widget to display Advertisement', 'viral')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'image' => array(
                ...
                'viral_widgets_title' => __('Advertisement Banner', 'viral'),
                'viral_widgets_field_type' => 'upload',
            ),
            'link' => array(
                'viral_widgets_name' => 'link',
                'viral_widgets_title' => __('Advertisement Link', 'viral'),
                'viral_widgets_field_type' => 'url',
            ),
            'newtab' => array(
                'viral_widgets_name' => 'newtab',
                'viral_widgets_title' => __('Open in new tab', 'viral'),
