...
class Viral_Contact_Info extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                ...
                'description' => __('A widget to display Contact Information', 'viral')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'phone' => array(
                ...
                'viral_widgets_title' => __('Phone', 'viral'),
                'viral_widgets_field_type' => 'text',
            ),
            'contact_info_email' => array(
                'viral_widgets_name' => 'email',
                'viral_widgets_title' => __('Email', 'viral'),
                'viral_widgets_field_type' => 'text',
            ),
            'website' => array(
                'viral_widgets_name' => 'website',
                'viral_widgets_title' => __('Website', 'viral'),
                'viral_widgets_field_type' => 'text',
            ),
            'address' => array(
                'viral_widgets_name' => 'address',
                'viral_widgets_title' => __('Contact Address', 'viral'),
                'viral_widgets_field_type' => 'textarea',
                'viral_widgets_row' => '4'
            ),
            'time' => array(
                'viral_widgets_name' => 'time',
                'viral_widgets_title' => __('Contact Time', 'viral'),
                'viral_widgets_field_type' => 'textarea',
                'viral_widgets_row' => '3'
            ),
        );
