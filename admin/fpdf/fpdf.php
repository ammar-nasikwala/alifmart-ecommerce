...
function Header()
{
	if(isset($_SESSION["company_id"])){
		if($_SESSION["header_image"] <> 1){
			get_rst("select letterhead_image from po_company_mast where po_company_id='".$_SESSION["company_id"]."'",$row);
			$this->Image($row["letterhead_image"],10,8,185,43);
			
		}else{
			unset($_SESSION["header_image"]);
		$this->Image('../images/Header_Image.JPG',10,8,185,43);
		}
	}else{
		$this->Image('../images/Header_Image.JPG',10,8,185,43);
	}
...
function Footer()
{
    ...
    // Page number
    $this->Cell(0,10,'www.Company-Name.com',0,0,'C');
}
