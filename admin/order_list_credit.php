...
$sql = $sql." from ord_summary os join ord_details od on os.cart_id=od.cart_id and os.user_id=od.memb_id and pay_method='OC'";
...
<table border="0" width="100%">
    ...
    <tr>
        <td>
			<?php create_ord_list($sql,"order_details_credit.php",20,"tbl_pages",5);?>
        </td>
    </tr>
</table>
