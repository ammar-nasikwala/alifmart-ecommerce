...
function home_banners($rst){
?>
    <script type="text/javascript" src="lib/slider/js/jssor.js"></script>
    <script type="text/javascript" src="lib/slider/js/jssor.slider.min.js"></script>
    <script>
        jssor_slider1_starter = function (containerId) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider1.$ScaleWidth(Math.min(parentWidth, 975));
                else
    ...
    <div id="slider1_container" class="slider-main">
        <!-- Slides Container -->
        <div u="slides" class="slider-child">
			<?
			while($row = mysqli_fetch_assoc($rst)){
				?>
				<div>
					<a href="<?=$row["banner_target_url"]?>"><img u=image src="<?=show_img($row["banner_img"])?>" /></a>
					<div u="thumb"></div>
			   </div>
				<?
			}
        ...
        <div u="thumbnavigator" class="jssort09 thumbnavigator">
            <div class="thumbnavigator-child1">
            </div>
            <!-- Thumbnail Item Skin Begin -->
            <div u="slides">
                <div u="prototype" class="thumbnavigator-prototype">
                    <div u="thumbnailtemplate" class="thumbnavigator-template"></div>
                </div>
            </div>
        ...
        <style>
            ...
            .jssorb01 div:hover, .jssorb01 .av:hover { background-color: #eb9316; }
            .jssorb01 .av { background-color: #eb9316; }
            .jssorb01 .dn, .jssorb01 .dn:hover { background-color: #555555; }
        </style>
        <!-- bullet navigator container -->

        <div u="navigator" class="jssorb01" style="bottom: 25px; right: 45%;">
        ...
        <style>
            ...
            */
            .jssora05l, .jssora05r {
                ...
                height: 50px;
                cursor: pointer;
                background: url(../lib/slider/img/a15.png) no-repeat;
                /*overflow: hidden;*/
            }
        ...
        <!-- Arrow Left -->
        <span u="arrowleft" class="jssora05l" style="top: 130px; left: 8px;">
        </span>
        <!-- Arrow Right -->
        <span u="arrowright" class="jssora05r" style="top: 130px; right: 8px;">
        </span>
        <!-- Trigger -->
        <script>
